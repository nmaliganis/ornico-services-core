  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      Log.Logger = new LoggerConfiguration()
        ...
        .MinimumLevel.Debug()
        .MinimumLevel.Override("ornico-core.api", LogEventLevel.Information)
        ...
        .WriteTo.RollingFile(HostEnv.WebRootPath + "//" + $"{DateTime.Now}.txt",
      ...
      services.AddSwaggerGen(c =>
      {
        ...
        {
          Title = "ornico-core.api - HTTP API",
          Version = "v1",
          Description = "The Catalog Microservice HTTP API for ornico-core.api service",
        });
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime lifetime)
    {
      ...
      app.UseSwagger()
        .UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "ornico-core.api - API V1"); });
